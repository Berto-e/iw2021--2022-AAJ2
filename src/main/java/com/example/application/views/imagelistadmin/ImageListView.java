...
public class ImageListView extends LitTemplate implements HasComponents, HasStyle {
    ...
    public ImageListView() {
        ...
        add(new ImageCard("Rio en montanita","River between mountains",
        ...
        add(new ImageCard("Niebla en montanita","Mountain with fog",
        ...
        add(new ImageCard("Montanota de noche","Mountain at night",
